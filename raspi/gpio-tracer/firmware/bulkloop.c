...
enum TRACER_STATE tracer_state = TSETUP;
...
BOOL handle_vendorcommand(BYTE cmd) {
  ...
  case VC_FWSTAT:
    {
      printf("returning Firmware status\n");
  ...
  case VC_RENUM:
    {
      printf("defer usb handling to fx2lp\n");
      if(!gpif_poll_finished()) {
        gpif_abort_transaction();
      }
...
void set_gpif_delay(unsigned char delay) {
  /* SET_WAVE_DELAY(2, 0, delay); */
  /* SYNCDELAY; */
  /* AUTOPTRH1  = MSB((WORD) delay_state); */
  /* AUTOPTRL1  = LSB((WORD) delay_state); */
